    ...
    private static Category[] GetSeedCategories()
    {
        return new Category[]
        {
            new Category
            {
                ...
                ProfileId = new Guid("fb12fd97-e08a-4793-8a17-f9bd70233749"),
                Name = "Test_Groceries",
            ...
            new Category
            {
                ...
                ProfileId = new Guid("208b0ac2-a0ca-438c-a5e5-fa7ab4dfa10a"),
                Name = "Test_Salary",
            ...
            new Category
            {
                ...
                ProfileId = new Guid("e106b3d6-a418-4569-afbb-ff680b41f7a0"),

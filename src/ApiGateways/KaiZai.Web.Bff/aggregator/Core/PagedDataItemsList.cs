...
public sealed class PagedDataItemsList<T> : List<T>
{
     /// <summary>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="PagedItemsList{T}"/> class.
    /// </summary>
    /// <param name="items">The collection of items in the current page.</param>
    /// <param name="totalCount">The total number of items across all pages.</param>
    /// <param name="currentPage">The current page number.</param>
    /// <param name="pageSize">The maximum number of items per page.</param>
    public PagedDataItemsList(IEnumerable<T> items, int totalCount, int currentPage, int pageSize)
    {
